...
\begin{itemize}
    ...
    \item[4.] Run the code (click ''Run'')! Hopefully you will see \texttt{Hello Pi!} in the shell in the lower part of the window.
\end{itemize}
